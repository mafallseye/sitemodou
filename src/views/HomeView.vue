...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
        <a href="#" class="flex items-center">
            <img src="../assets/mo-immo.png" class="h-10 mr-3 sm:h-9" alt="Flowbite Logo" />
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white cursive">MO IMMO</span>
        </a>
        <div class="flex items-center">
            <a href="tel:+221776881409" id="contact" class="mr-6 text-sm font-medium text-gray-500 dark:text-white hover:underline">+221 77 688 14 09</a>
            <!-- <a href="#" class="text-sm font-medium text-blue-600 dark:text-blue-500 hover:underline">Login</a> -->
        </div>
    </div>
</nav>
<nav class="bg-green-500 dark:bg-gray-700">
    <div class="max-w-screen-xl px-4 py-3 mx-auto md:px-6">
        <div class="flex items-center">
            <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
                <li>
                    <a href="#accueil" class="text-gray-900 dark:text-white hover:underline" aria-current="page">Accueil</a>
                </li>
                <li>
                    <a href="#perimetre" class="text-gray-900 dark:text-white hover:underline">Vente de périmètre</a>
                </li>
                <li>
                    <a href="#ervices" class="text-gray-900 dark:text-white hover:underline">Services</a>
                </li>
                <li>
...
<section class="bg-white dark:bg-gray-900">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div id="accueil" class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Vente de périmètre</h1>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              Vente de périmètre pour ceux qui veulent investir dans le domaine de
          l'agriculture comme dans le domaine de l'aviculture. Dans une zone
          très accessible à moins de 10 ms de la RN ou de l'autoroute Ila Touba
            </p>
           
            <a href="#contact" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-300 rounded-lg bg-green-500 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
               Contactez moi
            </a> 
        </div>
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img src="../assets/terrain1.png" alt="mockup">
        </div>                
    </div>
</section>
...
<div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="flex flex-col items-center pb-10">
        <img class="w-full px-2 h-60 mb-3  shadow-lg" src="../assets/terrain1.png" alt="Bonnie image"/>
        <!-- <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Bonnie Green</h5> -->
        <!-- <span class="text-sm text-gray-500 dark:text-gray-400">Visual Designer</span> -->
        <div class="flex mt-4 space-x-3 md:mt-6">
            <a href="https://wa.me/776881409" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Watsapp</a>
  ...
  <path d="M9.653 16.915l-.005-.003-.019-.01a20.759 20.759 0 01-1.162-.682 22.045 22.045 0 01-2.582-1.9C4.045 12.733 2 10.352 2 7.5a4.5 4.5 0 018-2.828A4.5 4.5 0 0118 7.5c0 2.852-2.044 5.233-3.885 6.82a22.049 22.049 0 01-3.744 2.582l-.019.01-.005.003h-.002a.739.739 0 01-.69.001l-.002-.001z" />
    ...
    <div class="flex flex-col items-center pb-10">
        <img class="w-full px-2 h-60 mb-3  shadow-lg" src="../assets/terrain.png" alt="Bonnie image"/>
        <!-- <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Bonnie Green</h5> -->
        <!-- <span class="text-sm text-gray-500 dark:text-gray-400">Visual Designer</span> -->
        <div class="flex mt-4 space-x-3 md:mt-6">
            <a href="https://wa.me/776881409" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Watsapp</a>
  ...
  <path d="M9.653 16.915l-.005-.003-.019-.01a20.759 20.759 0 01-1.162-.682 22.045 22.045 0 01-2.582-1.9C4.045 12.733 2 10.352 2 7.5a4.5 4.5 0 018-2.828A4.5 4.5 0 0118 7.5c0 2.852-2.044 5.233-3.885 6.82a22.049 22.049 0 01-3.744 2.582l-.019.01-.005.003h-.002a.739.739 0 01-.69.001l-.002-.001z" />
    ...
    <div class="flex flex-col items-center pb-10">
        <img class="w-full px-2 h-60 mb-3  shadow-lg" src="../assets/terrain2.png" alt="Bonnie image"/>
        <!-- <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Bonnie Green</h5> -->
        <!-- <span class="text-sm text-gray-500 dark:text-gray-400">Visual Designer</span> -->
        <div class="flex mt-4 space-x-3 md:mt-6">
            <a href="https://wa.me/776881409" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Watsapp</a>
  ...
  <path d="M9.653 16.915l-.005-.003-.019-.01a20.759 20.759 0 01-1.162-.682 22.045 22.045 0 01-2.582-1.9C4.045 12.733 2 10.352 2 7.5a4.5 4.5 0 018-2.828A4.5 4.5 0 0118 7.5c0 2.852-2.044 5.233-3.885 6.82a22.049 22.049 0 01-3.744 2.582l-.019.01-.005.003h-.002a.739.739 0 01-.69.001l-.002-.001z" />
    ...
    <div class="flex flex-col items-center pb-10">
        <img class="w-full px-2 h-60 mb-3  shadow-lg" src="../assets/terrain3.png" alt="Bonnie image"/>
        <!-- <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Bonnie Green</h5> -->
        <!-- <span class="text-sm text-gray-500 dark:text-gray-400">Visual Designer</span> -->
        <div class="flex mt-4 space-x-3 md:mt-6">
            <a href="https://wa.me/776881409" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Watsapp</a>
  ...
  <path d="M9.653 16.915l-.005-.003-.019-.01a20.759 20.759 0 01-1.162-.682 22.045 22.045 0 01-2.582-1.9C4.045 12.733 2 10.352 2 7.5a4.5 4.5 0 018-2.828A4.5 4.5 0 0118 7.5c0 2.852-2.044 5.233-3.885 6.82a22.049 22.049 0 01-3.744 2.582l-.019.01-.005.003h-.002a.739.739 0 01-.69.001l-.002-.001z" />
    ...
    <div class="flex flex-col items-center pb-10">
        <img class="w-full px-2 h-60 mb-3  shadow-lg" src="../assets/terrain4.png" alt="Bonnie image"/>
        <!-- <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Bonnie Green</h5> -->
        <!-- <span class="text-sm text-gray-500 dark:text-gray-400">Visual Designer</span> -->
        <div class="flex mt-4 space-x-3 md:mt-6">
            <a href="https://wa.me/776881409" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Watsapp</a>
    ...
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="#" class="flex items-center">
                    <img src="../assets/mo-immo.png" class="mr-3 h-8" alt="FlowBite Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white cursive">MO IMMO</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li>
                            <a href="#" class="hover:underline">Vente périmètre</a>
                        </li>
                    </ul>
                </div>
                <div>
